...
public class Test2 {
    ...
    public static void main(String[] args) {
        System.out.println("CQEngine Test2 - lots of queries - starting");
        ...
        int testSize = testCollection(cars, Car::new, or(equal(Car.MAKE, "Ford"), equal(Car.COLOUR, "Red")), -1);
        ...
        testCollection(cars2, (m) -> m, or(equal(getAttrib("make"), "Ford"), equal(getAttrib("colour"), "Red")), testSize);
